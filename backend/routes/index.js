...
module.exports = app => {
    ...
    app.post(`${basePath}/forgotPassword`, controller.forgotPassword);
    app.post(`${basePath}/resetPassword`, controller.resetPassword); 
    ...
    app.post(`${basePath}/change-password`, controller.changePassword); 
};
